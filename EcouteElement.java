	...
	public void mouseReleased(MouseEvent e) {
		...
		if (e.getButton() == MouseEvent.BUTTON3) {
			...
			if (e.isPopupTrigger()) {
				...
				JMenuItem send = new JMenuItem("Envoyer un message");
				menu.add(send);
		...
		if (e.getButton() == MouseEvent.BUTTON1) {
			...
			if (this.getPan().getPan().getPan().getPanneauBouton().isConnectSelected() == false) {
			...
			if (pan.getPan().getPanelPrincipal().getPanneauBouton().isConnectSelected()) {
				...
				if (pan.getPan().getEtapeConnection() == 1) {
					...
					System.out
							.println("X1 = " + pan.getPan().getxClic1Elem() + " Y1 = " + pan.getPan().getyClic1Elem());
					...
					try {
						...
						Logger.getLogger(EcouteElement.class.getName()).log(Level.SEVERE, null, ex);
					...
					if (pan.getPan().getElem1() instanceof Machine | pan.getPan().getElem1() instanceof Switch
						...
						System.out.println(
								"X1 = " + pan.getPan().getxClic2Elem() + " Y1 = " + pan.getPan().getyClic2Elem());
